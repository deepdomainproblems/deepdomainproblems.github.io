---
title: "Ubiquitous language: The foundation for solving DDPs"
...
As I outlined in "[How to Break Down a Deep Domain Problem](/chapter/how-to-break-down-a-deep-domain-problem)," the first step in tackling complex domain challenges is knowledge extraction and mapping—with building a domain glossary as the critical starting point.
...
In "[How to Identify Deep Domain Problems Worth Solving](/chapter/how-to-identify-deep-domain-problems-worth-solving)," I highlighted how DDPs rely on tacit expertise—knowledge that experts find difficult to articulate clearly. Building a Ubiquitous Language forces experts to make this tacit knowledge explicit by defining terms precisely.
...
In our "[Case Study: Decomposing a DDP in Supply Chain Optimization](/chapter/case-study-breakdown-a-ddp)," establishing a shared glossary was the critical first step:
